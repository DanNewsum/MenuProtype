...
namespace Project2 {
	...
	/// <summary>
	/// Summary for BurgerkingCheckout
	/// </summary>
	public ref class BurgerkingCheckout : public System::Windows::Forms::Form
	{
	public:
		BurgerkingCheckout(double mealValueCount, double burgerValueCount, double friesValueCount, double drinkValueCount)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Click += gcnew System::EventHandler(this, &BurgerkingCheckout::label3_Click);
			// 
			// label2
			// 
			...
			this->label2->Click += gcnew System::EventHandler(this, &BurgerkingCheckout::label2_Click);
			// 
			// label1
			// 
			...
			this->label1->Text = L"Burger King Total";
			this->label1->Click += gcnew System::EventHandler(this, &BurgerkingCheckout::label1_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &BurgerkingCheckout::button1_Click);
			// 
			// BurgerkingCheckout
			// 
			...
			this->Name = L"BurgerkingCheckout";
			this->Text = L"BurgerkingCheckout";
